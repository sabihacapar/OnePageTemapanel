...
<body>
                ...
                <form action="" method="POST">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="submit-btn-area">
                            <input type="submit" class="btn btn-dark" value="GİRİŞ"/>
                        </div>
                    </div>
    ...
    $kulad=htmlspecialchars($_POST["kulad"]);
     ...
     if($kulad=="" && $sifre==""):
        ...
        <div class="alert alert-white border border-dark mt-5 col-md-5 mx-auto p-3 text-dark font-14 font-weight-bold">Bilgiler Boş Olamaz </div>
        </div>
        ...
        //veritabanı işlemleri bu kısımda yapılır
